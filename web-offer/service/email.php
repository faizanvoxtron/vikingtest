...
function email($id,$table,$emailId) {
    ...
    $url = $site."web-offer/data/view.php?value=".$url;
...
function SendCompany($title, $ctx, $subtitle,  $url, $notification, $html, $emailId, $emailTitle, $customerTitle, $customerSubtitle, $customerNotification, $email ) {
    ...
    $replace = Array( $title, "https://designvikings.us/query/assets/images/email-logo.png", "Design Vikings", "3200 14th Street Ste 414, Plano, TX 75074", "+1 817 533 6583", "support@designvikings.us", $subtitle, $url, $notification );
    ...
    try {
        ...
        $mail->addCC('sales@designvikings.us');
...
function SendCustomer($emailTitle, $title, $subtitle, $notification, $email, $emailId, $ctx) {
    ...
    $replace = Array( $title, "https://designvikings.us/query/assets/images/email-logo.png", "Desig Vikings", "3200 14th Street Ste 414, Plano, TX 75074", "+1 817 533 6583", "support@designvikings.us", $subtitle, $notification );
