...
<head>
    ...
    <link rel="stylesheet" href="assets/css/service-style.css?v=0.9">
                        ...
                        <form style="padding-bottom: 60px;" id="payForm" method="POST" action="javascript:pay('payForm');">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" value="" name="postal" class="form-control" id="PostalCode" placeholder="☞ type here" required maxlength="5" minlength="4">
                                </div>
                                <div class="col-md-12">
                                    <hr>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="cardnumber" placeholder="☞ type here" id="card_number" onblur="validate_cc(this)" minlength="16" maxlength="16" onkeyup="validate_cc(this)" required>
                        ...
                        <div class="sidebar">
                            <div class="boxpackages">
                                ...
                                <div class="package_content">
                                    <!--<p class="text-center">Add on: AUD150 for expedited services</p>-->
                                    <ul>
                                        <li><?= $pages ?></li>
                                        <li><?= $stockphotos ?></li>
                                        <li><?= $banner ?></li>
