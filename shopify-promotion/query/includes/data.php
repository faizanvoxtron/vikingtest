<!--Landing Packages-->
<?php
$package = "Shopify Starter Package";
$dprice = "$499";
$price = "$499";
$logo = "Custom designed Homepage (1x concepts)";
$designer = "5 Custom designed Inner pages";
$revisions = "Upto 100 Products";
$fileformat = "Upto 7 Categories";
$time = "24/7 Customer Support";

if ($_GET['package'] == "Shopify Starter Package") {
  $package = "Shopify Starter Package";
$dprice = "$499";
$price = "$499";
$logo = "Custom designed Homepage (1x concepts)";
...
if ($_GET['package'] == "Shopify Professional Package") {
    $package = "Shopify Professional Package";
    $dprice = "$999";
    $price = "$999";
    $logo = "Custom designed Homepage (3x concepts)";
    $designer = "20 Custom designed Inner pages";
    $revisions = "Interactive and Dynamic Website Design";
    $fileformat = "Upto 1000 Products";
    $time = "24/7 Customer Support";
}

if ($_GET['package'] == "Shopify Business Package") {
    $package = "Shopify Business Package";
    $price = "$2699";
    $dprice = "$2699";
    $logo = "Custom designed Homepage (3x concepts)";
    $designer = "20 Custom designed Inner pages";
...
if ($_GET['package'] == "Shopify Enterprise Package") {
    $package = "Shopify Enterprise Package";
    $price = "$4499";
    $dprice = "$4499";
    $logo = "Custom designed Homepage (6x concepts)";
    $designer = "Unlimited Custom designed Inner pages";
    $revisions = "Custom Made, Interactive, Dynamic User Friendly Design";
    $fileformat = "High End UI|UX";
    $time = "24/7 Customer Support";
}
...
$packages = array ('Shopify Starter Package','Shopify Professional Package','Shopify Business Package','Shopify Enterprise Package');
