...
<head>
  ...
  <link rel="shortcut icon" href="query/assets/images/favicon.png?v=1" type="image/png">
  <!-- Bootstrap CSS -->
      ...
      <div class="row">
        <div class=col-md-6>
          <div class="logo-wrapper">
            <a href="https://designvikings.us"><img src="assets/images/logo.png" class="img-fluid" alt="Logo" width="200px" height="200px"></a>
          </div>
        </div>
        <div class=col-md-6>
