...
function email($id,$table,$emailId) {
    ...
    $url = $site."website-design-promotion/data/view.php?value=".$url;
    ...
    if ($table == "leads") {
        ...
        $customerNotification = "Great! You are just 2 steps away to activate the 76% Flat discount offer!<br>Please process the required brief.<br><br>OR<br><br>Call us now at Tollfree:<a style='text-decoration:none; color:red; font-weight:bold;' href='tel:+1 817 533 6583'> +1 817 533 6583</a>";
    ...
    if ($table == "briefs") {
        ...
        $subtitle = "Logo Type: ".$data[0]['Logo']."<br>Name on Logo: ".$data[0]['LogoName'];
        ...
        $customerSubtitle = "Your ".$data[0]['Logo']." ".$data[0]['LogoName']." logo requirements are recorded.";
        $customerNotification = "You are just a step away to activate your 75% discount offer.<br>Please process the payment";
    ...
    if ($table == "payments"){
        ...
        $subtitle = "Package Activated.<br>Order# BLD-000".$data[0]['id']."-75/".date("m")."/".date("Y");
        ...
        $customerSubtitle = "Offer Activated on your order!<br> Your Order# <b style='color:green;'>BLD-000".$data[0]['id']."-75/".date("m")."/".date("Y")."</b>";
...
function SendCompany($title, $ctx, $subtitle,  $url, $notification, $html, $emailId, $emailTitle, $customerTitle, $customerSubtitle, $customerNotification, $email ) {
    ...
    $replace = Array( $title, "https://designvikings.us/query/assets/images/email-logo.png", "Design Vikings", "27 Rowena Place Cherrybrook, NSW 2126", "+1 817 533 6583", "sales@designvikings.us", $subtitle, $url, $notification );
    ...
    try {
        ...
        $mail->addCC('joshua@designvikings.us');
        $mail->addBCC('aaron@designvikings.us');
...
function SendCustomer($emailTitle, $title, $subtitle, $notification, $email, $emailId, $ctx) {
    ...
    $replace = Array( $title, "https://designvikings.us/query/assets/images/email-logo.png", "Design Vikings", "27 Rowena Place Cherrybrook, NSW 2126", "+1 817 533 6583", "sales@designvikings.us", $subtitle, $notification );
    ...
    try {
        ...
        // $mail->addCC('aaron@designvikings.us');
