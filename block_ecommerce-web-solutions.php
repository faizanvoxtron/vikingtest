        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title text-center">
                    ...
                    <p>The Ecommerce industry is tough to compete in, its slowly becoming harder and harder for e-stores to succeed online. With our Ecommerce Packages, we help your company reach the very top.</p>
    ...
    <div class="container">
        ...
        <div class="row portfolio-grid">
            <div class="col-lg-4 col-md-6 col-sm-12  portfolio-column cat-2">
                <div class="portfolio-item portfolio-style-one mb-55 wow fadeInUp" data-wow-delay=".1s">
                    <div class="img-holder">
                        <img src="assets/images/showcase/ecommerceweb/01.jpg" alt="Img">
                        <a href="assets/images/showcase/ecommerceweb/01.jpg" class="portfolio-hover img-popup">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12  portfolio-column cat-2">
                <div class="portfolio-item portfolio-style-one mb-55 wow fadeInUp" data-wow-delay=".1s">
                    <div class="img-holder">
                        <img src="assets/images/showcase/ecommerceweb/02.jpg" alt="Img">
                        <a href="assets/images/showcase/ecommerceweb/02.jpg" class="portfolio-hover img-popup">
                            <div class="hover-content">
                                <i class="far fa-plus"></i>
                            </div>
                        </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12  portfolio-column cat-2">
                <div class="portfolio-item portfolio-style-one mb-55 wow fadeInUp" data-wow-delay=".1s">
                    <div class="img-holder">
                        <img src="assets/images/showcase/ecommerceweb/03.jpg" alt="Img">
                        <a href="assets/images/showcase/ecommerceweb/03.jpg" class="portfolio-hover img-popup">
                            <div class="hover-content">
                                <i class="far fa-plus"></i>
                            </div>
                        </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="text-wrapper mb-50 wow fadeInLeft">
                    ...
                    <p>Our family of WordPress web designers and developers, ecommerce website designers and pretty much any website design help us stand tall against some of the best website design and development companies online. </p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".2s">
                    <div class="pricing-head text-center">
                        <span class="plan">E-Commerce Basic
                            Package</span>
                    ...
                    <div class="pricing-body">
                        ...
                        <div class="actions">
                            <div class="row">
                                <div class="col-md-6 col-xs-6"><a class="action-no clearfix pur" href="tel:(+61) 420 809 806"><span><small>Speak with us</small>(+61) 420 809 806</span></a></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div class="pricing-head text-center">
                        <span class="plan">E-Commerce Startup
                            Package</span>
                        <h2 class="price"><span class="currency">A$</span>699.00</h2>
                    </div>
                    <div class="pricing-body">
                        <p class="text-center">Suitable for potential super-startups and brand revamps for companies.</p>
                        <ul class="pricing-list">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".4s">
                    <!-- <div class="ribbon">Best Seller</div> -->
                    <div class="pricing-head text-center">
                        <span class="plan">E-Commerce Professional
                            Package</span>
                        <h2 class="price"><span class="currency">A$</span>1199.00</h2>
                    </div>
                    <div class="pricing-body">
                        <p class="text-center">Suitable for potential super-startups and brand revamps for companies.</p>
                        <ul class="pricing-list">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".4s">
                    <div class="pricing-head text-center">
                        <span class="plan">E-Commerce Identity
                            Package</span>
                        <h2 class="price"><span class="currency">A$</span>1699.00</h2>
                    </div>
                    <div class="pricing-body">
                        <p class="text-center">Suitable for potential super-startups and brand revamps for companies.</p>
                        <ul class="pricing-list">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".4s">
                    <div class="pricing-head text-center">
                        <span class="plan">E-Commerce Elite
                            Package
                        </span>
                        <h2 class="price"><span class="currency">A$</span>2499.00</h2>
                    </div>
                    <div class="pricing-body">
                        <p class="text-center">Suitable for potential super-startups and brand revamps for companies.</p>
                        <ul class="pricing-list">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".4s">
                    <div class="pricing-head text-center">
                        <span class="plan">E-Commerce Corporate
                            Package</span>
                        <h2 class="price"><span class="currency">A$</span>3699.00</h2>
                    </div>
                    <div class="pricing-body">
                        <p class="text-center">Suitable for potential super-startups and brand revamps for companies.</p>
                        <ul class="pricing-list">
...
<!--====== End pricing section ======-->
<!--====== Start Combo section ======-->
<section class="features-area combo-package-section">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="text-wrapper mb-50 wow fadeInLeft text-center">
                    <div class="section-title mb-30">
                        <span class="sub-title st-one">WEB PACKAGE</span>
                        <h2>CUSTOMIZED WEB PORTAL</h2>
                        <p class="blue-dark">Suitable for Multinational Organizations seeking state of the art web solutions</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row combo-package">
            <div class="col-md-3">
                <div class="text-wrapper mb-50 wow fadeInLeft">
                    <ul class="pricing-list">
            ...
            <div class="col-md-3">
                <div class="text-wrapper mb-50 wow fadeInLeft">
                    <ul class="pricing-list">
                        <li>Aware Winning Team of Expert Designers and Developers</li>
                        <li>Complete Deployment</li>
                        <li class="heading">– Value Added Services</li>
                        <li>Complete Source Files</li>
                        <li>Dedicated Project Manager</li>
            ...
            <div class="col-md-3 col-md-3 col-sm-12">
                <div class="pricing-item pricing-item-two bg-white mb-40 wow fadeInUp" data-wow-delay=".2s">
                    <div class="pricing-head text-center">
                        <span class="plan">WEB PACKAGE</span>
                        <h2 class="price"><span class="currency">A$</span>4,499</h2>
                    </div>
