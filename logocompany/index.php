<?php
define("NITROPACK_HOME_URL", "https://designvikings.us/logocompany"); 
define("NITROPACK_SITE_ID", "MshOMjUQTWAbVfUpXKakigDLtpidWbCH"); 
define("NITROPACK_SITE_SECRET", "7xGCycrOSKuQkwczQpV3uujYtntDBX585YV7sx7CtZUtWnSjmNWQOpu4TaR9FOZ3"); 
            ...
            <div class="row d-flex">
               <div class="col-md-4 col-sm-4 col-xs-12">
                  <a href="https://designvikings.us" class="logo_area">
                     ...
                     <img class="main-logo" src="images/logo.png" alt="Design Vikings" width="100px" height="100px">
            ...
            <div class="row">
               <div class="col-md-12 header-content">
                  <div class="banner_content">
                     <p>Create a &nbsp;<span class="txt-yellow banner-txt-md">Custom Logo</span>&nbsp; for Your Business in just</p>
                     <h1>$ <span>35</span></h1>
                     ...
                     <p style="margin-top: 19px;">Best logo design company at your service Get your custom logo by industry experts.</p>
            ...
            <div id="logos-type" class="owl-carousel">
               <div class="item">
                  <div class="col-md-7 col-sm-6 col-xs-12 logo-content">
                     ...
                     <p>Flat professional logo design is made from simple 2D images without any knotty details. A flat business logo design from best logo design companies involves minimalistic typography and design elements that convey the brand message effectively. A simple professional custom logo design can be used anywhere.</p>
               ...
               <div class="item">
                  <div class="col-md-7 col-sm-6 col-xs-12 logo-content">
                     ...
                     <p>3D custom logos are one step further from all other types of logos because they exhibit and demonstrate a sense of depth and dimensionality to the feel and look of custom logo. Custom logo design companies incorporate gradients, textures, shadows and elements that create a depth-defining illusion to give an edge and modern look to the logo. 3D logos are more identifiable due to their cool appearance, and hence are easy to remember.</p>
                     <a href="javascript:;" data-fancybox="" data-src="#popupform" class="header-btn various btn-orangedark get_started inquirybtncta">Let's Start</a>
                  </div>
               ...
               <div class="item">
                  <div class="col-md-7 col-sm-6 col-xs-12 logo-content">
                     ...
                     <p>This type involves designing a custom logo keeping the symbol or icon of an entity as the centerpiece. The icon is the representative and generally is the first thing recalled in customer’s mind when thinking of logo. Icon-based company logo maker that impresses your customers in the blink of an eye.</p>
                     <a href="javascript:;" data-fancybox="" data-src="#popupform" class="header-btn various btn-orangedark get_started inquirybtncta">Let's Start</a>
                  </div>
               ...
               <div class="item">
                  <div class="col-md-7 col-sm-6 col-xs-12 logo-content">
                     ...
                     <p>A step above the simple custom logo, illustrative logos inculcates intricate details such as drawings or elements which effectively communicates the brand’s story. It is something to which the customers can immediately resonate with. Its novel design and unique approach make it a standout performer for brands. Illustrative logo makers possess the necessary skills to add flavor of originality in this type of logo design.
</p>
                     <a href="javascript:;" data-fancybox="" data-src="#popupform" class="header-btn various btn-orangedark get_started inquirybtncta">Let's Start</a>
                  </div>
               ...
               <div class="item">
                  <div class="col-md-7 col-sm-6 col-xs-12 logo-content">
                     ...
                     <p>Mascot logo design can be termed as ambassadors of the brand. They are characters picked by the businesses as representative of their brand image/name. These characters help the viewers to recognize brand within an instance and are relatable. A high-skilled company logo maker designs logos that act as the face of many fast food retail, entertainment and sports brands worldwide.
</p>
                     <a href="javascript:;" data-fancybox="" data-src="#popupform" class="header-btn popup_open btn-orangedark get_started inquirybtncta">Let's Start</a>
                  </div>
               ...
               <div class="item">
                  <div class="col-md-7 col-sm-6 col-xs-12 logo-content">
                     ...
                     <p>Typography logos are text-based incorporating symbols and design elements. This type of designs is often used by new companies and startups that aim to make a name for themselves in the industry. It is simple and affordable option which allows brand to establish a distinct identity. Although simple in many terms, logo designing companies tend to have tons of expertise and experience to craft a uniquely identifiable masterpiece that fits well with business philosophy.
</strong></p>
                     <a href="javascript:;" data-fancybox="" data-src="#popupform" class="header-btn various btn-orangedark get_started inquirybtncta">Let's Start</a>
                  </div>
