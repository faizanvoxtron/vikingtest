<?php
define("NITROPACK_HOME_URL", "https://designvikings.us/custom-logo-design/"); 
define("NITROPACK_SITE_ID", "WLgqGCVBHfMUKfIPEYKMpsfQnEweEUbF"); 
define("NITROPACK_SITE_SECRET", "LxaqfMHIiBOzRh4K7jy56y7PzsWBN0bjHeSFKhAK3rE393QvJVprgDMQjAgeN3Yp"); 
...
<head>
   ...
   <title>Custom Logo Design for your Brand Identity | Design Vikings</title>
   <meta name="description" content="Get your Custom Logo Design today starting from $35 only at Design Vikings. We are offering straight 70% off on our Custom Logo Design Service. Unlike other Logo Design Companies we do not use pre defined templates as we believe in creating your Brand Identity unique.">
...
<body>
            ...
            <div class="row d-flex">
               <div class="col-md-4 col-sm-4 col-xs-12">
                  <a href="https://designvikings.us" class="logo_area">
                     ...
                     <img class="main-logo" src="images/logo.svg?v=0.5" alt="Business Logo Design" width="100px" height="100px">
            ...
            <div class="row">
               <div class="col-md-12 header-content">
                  <div class="banner_content">
                     <h1 style="font-size:23px; margin:0px;">Get a <span class="txt-yellow banner-txt-md" style="font-size:24px;">Custom Logo Design</span> in just</h1>
                     <h1>$ <span>35</span></h1>
                     ...
                     <p style="margin-top: 19px;">Get Your Business Logo <br />By Highly Skilled Logo Designers</p>
                     <ul>
               ...
               <div class="col-md-7  col-xs-12">
                  <div class="logo-card-cover">
                     <div class="logo-cards clearfix">
                        <div>
                           <div class="logo-card">
                              <div class="front"><img src="images/flip/flip1.webp" alt="Custom Logo Design" /></div>
                              <div class="back"><img src="images/flip/flip1-bk.webp" alt="Logo Design Companies" /></div>
                           </div>
                        </div>
                        <div>
                           <div class="logo-card">
                              <div class="front"><img src="images/flip/flip2.webp" alt="Business Logo Design" /></div>
                              <div class="back"><img src="images/flip/flip11.webp" alt="Logo Maker" /></div>
                           </div>
                        </div>
                        <div>
                           <div class="logo-card">
                              <div class="front"><img src="images/flip/flip3.webp" alt="Custom Logo Design" /></div>
                              <div class="back"><img src="images/flip/flip3-bk.webp" alt="Logo Creator" /></div>
                           </div>
                        </div>
                        <div>
                           <div class="logo-card">
                              <div class="front"><img src="images/flip/4.webp" alt="Logo Design" /></div>
                              <div class="back"><img src="images/flip/flip4-bk.webp" alt="Create a Logo" /></div>
                           </div>
                        </div>
                        <div>
                           <div class="logo-card">
                              <div class="front"><img src="images/flip/flip5.webp" alt="Logo Designer" /></div>
                              <div class="back"><img src="images/flip/flip5-bk.webp" alt="Logo Design Company" /></div>
                           </div>
                        </div>
                        <div>
                           <div class="logo-card">
                              <div class="front"><img src="images/flip/flip6.webp" alt="Business Logos" /></div>
                              <div class="back"><img src="images/flip/flip6-bk.webp" alt="brand logo maker" /></div>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="container">
            <div class="social-left">
               <ul class="bxslider1">
                  ...
                  <li>Brand Logos' Cherished Worldwide</li>
               </ul>
            </div>
   ...
   <section class="sec-4 cta-center ">
      <div class="container">
         <div class="row justify-content-center">
            <h3 class="mb-4"><strong>Custom</strong> Logo Design  <strong>that portrays </strong><br>your Business Identity.</h3>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12 heading-area">
               <h2>Skim through our <strong>Custom Logo Design Work</strong></h2>
            </div>
   ...
   <section class="pricing-sec ">
      <div class="container">
         <div class="col-lg-12">
            <h2>Get Your Brand Logo created by highly skilled <strong>Logo Design</strong> teams.</h2>
            <p>A <strong>Custom Logo and Brand Identity</strong> can make your marketing efforts more effective, as it can help grab customers' attention and communicate your brand's message more clear.</p>
         </div>
               ...
               <div class="price-box-main pricing-box" data-package-box>
                  ...
                  <div class="price_body mCustomScrollbar " data-package-scroll>
                     <ul>
                        ...
                        <li> 4 Dedicated Logo Designers (Industry Specific)</li>
                        <li> Unlimited Revisions</li>
               ...
               <div class="price-box-main pricing-box" data-package-box>
                  ...
                  <div class="price_body mCustomScrollbar " data-package-scroll>
                     <ul>
                        ...
                        <li>8 Dedicated Logo Designers (Industry Specific)</li>
                        <li>Unlimited Revisions</li>
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="package-content">
                  ...
                  <p>Our <strong>All-Inclusive Bundle</strong> is viable for entrepreneurs and startups looking to setup their business at the very initial stage. This can help you design everything that you need for a business to grow your reach and solidify your online existence. Get hands-on experience of Custom Logo Design that can be used anywhere. Grab the opportunity with both hands to take all-out benefits from our exclusive bundle.</p>
                  <div class="left-one">
                     <!-- <h6>Logo Design</h6> -->
                     <ul>
                        <li>Unlimited Logo Design Concepts </li>
                        <li>12 Dedicated Logo Designers (Industry Specific) </li>
                        <li>Unlimited Revisions </li>
   ...
   <section class="our-process-sec">
      <div class="our-process-container mob-hide">
         <div class="section-title">
            ...
            <p style="text-align:left;">We create Custom Logos from scratch that are tailored to your unique Brand Identity, rather than relying on pre-made templates or generic designs. Our focus is just not to make a Custom Logo Design for you, but also developing a comprehensive Brand Identity system that includes Brand Strategy, Messaging, and Visual Design.</p>
            <br>
            <h5 style="text-align:left; font-size:22px;">Turn Around Time?</h5>
            <p style="text-align:left;">We offer fast turnaround time for Custom Logo Design projects without sacrificing quality, so you do not have to worry about tight deadlines. Unlike other Logo Design Companies we do not charge extra fee for expedited process and delivers your Logo Designs with in 24 to 48 hours.</p>
            <br>
         ...
         <div class="process-container container responsive-slider2">
            ...
            <div class="single-process wow fadeIn" data-wow-delay="0.5s">
               ...
               <h6>Design</h6>
               <div class="process-desc">
                  <p>Our Logo Design specialists ensure that all those elements that are essential for your Brand Identity are embedded within your particular Logo Design.</p>
               </div>
            </div>
      ...
      <div class="container">
         <div class="row align-items-center">
            <div class="col-md-4  col-xs-12 secnd-cta-title no-padding-left">
               <h3 style="font-size:23px;">Let's Create Your<br>Custom Logo Design.</h3>
            </div>
