...
function SendCustomer($emailTitle, $title, $subtitle, $notification, $email, $emailId, $ctx) {
    ...
    $replace = Array( $title, "https://designvikings.us/query/assets/images/email-logo.png", "Desig Vikings", "3200 14th Street Ste 414, Plano, TX 75074", "+1 817 533 6583", "support@designvikigns.us", $subtitle, $notification );
